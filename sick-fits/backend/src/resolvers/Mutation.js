...
const Mutations = {
  ...
  async deleteItem(parent, args, ctx, info) {
    ...
    // At least one of the permissions is in the required ones!
  ...
  async signup(parent, args, ctx, info) {
    ...
    // create a user in the DB (info: what data return to the client)
  ...
  async resetPassword(parent, args, ctx, info) {
    ...
    // 3. Check if it's expired (cannot use USER query as WHERE
    // only works with unique fields (id, email))
